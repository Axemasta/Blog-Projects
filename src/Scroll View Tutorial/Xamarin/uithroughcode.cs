//This page will not compile unless. To compile this page navigate to the main project, remove the XAML & uncomment out the code in the .cs file (which is this code)
            InitializeComponent();
